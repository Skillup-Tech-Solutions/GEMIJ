...
const AdminSubmissionDetails: React.FC = () => {
    ...
    const loadSubmission = async () => {
        try {
            // Using submissionService.getSubmission which should be accessible to admins too
            // If not, we might need a specific admin service method, but usually getSubmission is generic enough or protected by backend roles
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                    <InfoSection
                        ...
                        subtitle="Key details about the submission"
                    >
                    ...
                    <InfoSection
                        ...
                        subtitle="Contact and affiliation information"
                        accent
                    >
                        <div className="space-y-4">
                            <div className="bg-primary-50 p-4 rounded-lg border border-primary-200">
                                ...
                                <p className="text-sm text-muted-foreground mb-1">
                                    <span className="font-medium">Email:</span> {submission.author.email}
                                </p>
                                {submission.author.affiliation && (
                                    <p className="text-sm text-muted-foreground">
                                        <span className="font-medium">Affiliation:</span> {submission.author.affiliation}
                                    </p>
                                )}
                            </div>
