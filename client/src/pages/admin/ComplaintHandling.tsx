...
const ComplaintHandling: React.FC = () => {
  ...
  const getPriorityBadgeVariant = (priority: string): 'error' | 'warning' | 'info' | 'success' | 'neutral' => {
    switch (priority) {
  ...
  const getTypeBadgeVariant = (type: string): 'error' | 'warning' | 'info' | 'success' | 'neutral' => {
    switch (type) {
      case 'PLAGIARISM': return 'error';
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex space-x-1 mb-6">
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${activeTab === 'complaints'
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${activeTab === 'retractions'
                ? 'bg-primary-100 text-primary-700'
                : 'text-secondary-600 hover:bg-secondary-50 hover:text-secondary-900'
              }`}
          >
