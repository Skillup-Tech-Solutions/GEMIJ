      ...
      <div className="min-h-screen bg-secondary-50">
        <div className="bg-white border-b border-border">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-3 leading-tight">Submissions</h1>
            <p className="text-base text-muted-foreground leading-relaxed">Select a submission to track reviews</p>
          </div>
        </div>
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
