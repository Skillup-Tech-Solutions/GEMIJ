        ...
        <section>
          ...
          <div className="prose prose-secondary max-w-none">
            <p className="text-secondary-700 leading-relaxed mb-4">
              The International Journal of Advanced Technology, Engineering and Management (GEMIJ) is a peer-reviewed,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-secondary-700">GEMIJ Publications</p>
              </div>
            </div>
            ...
            <div className="card">
              <div className="card-body">
                ...
                <p className="text-secondary-700">
                  GEMIJ is committed to providing immediate open access to all published content.
